...
Интерактивный экзамен для бариста: 20 вопросов о кофе, экстракции, молоке и латте-арте. С таймером и автоматической отправкой результатов.
...
2. Проходит тест (20 вопросов) на время
...
```
Barista1/
  index.html    -- главная страница (тест для бариста)
  README.md
  LICENSE
  .gitignore
```
